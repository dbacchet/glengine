...
class GLCamera {
  public:
    ...
    void set_ortho(float nearpl, float farpl, float left, float right, float bottom, float top) {
        _mode = GLCamera::Projection::Orthographic;
        _near_plane = nearpl;
        _far_plane = farpl;
        _left_plane = left;
        _right_plane = right;
    ...
    void set_perspective(float nearpl, float farpl, float fov) {
        _mode = GLCamera::Projection::Perspective;
        _near_plane = nearpl;
        _far_plane = farpl;
        _fov = fov;
    }
...
inline bool GLCamera::update(uint32_t width, uint32_t height) {
...
// create ortographic projection
inline bool GLCamera::create_orthographic_proj(void) {
...
// create perspective projection
inline bool GLCamera::create_perspective_proj(void) {
...
// basic initialization
inline void GLCamera::init(void) {
    // default values
    _mode = Projection::Perspective;
