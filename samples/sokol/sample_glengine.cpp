...
int main(void) {
    ...
    glengine::Renderable grid_renderable = {eng.create_grid_mesh(50.0f, 1.0f),
        eng.create_material<glengine::MaterialVertexColor>(SG_PRIMITIVETYPE_LINES, SG_INDEXTYPE_NONE)};
    glengine::Renderable box0_renderable = {eng.create_box_mesh({1, 1, 1}),
    ...
    glengine::Renderable box1_renderable = {box0_renderable.mesh, // reuse existing box0 mesh
                                            // eng.create_material("box1_mtl", glengine::StockShader::Phong)};
        eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)};
    ...
    glengine::Renderable box4_renderable = {eng.create_box_mesh({1, 1, 1}),
        eng.create_material<glengine::MaterialVertexColor>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)};
    glengine::Renderable axis_renderable = {eng.create_axis_mesh(),
        eng.create_material<glengine::MaterialVertexColor>(SG_PRIMITIVETYPE_LINES, SG_INDEXTYPE_NONE)};
    glengine::Renderable sphere_renderable = {eng.create_sphere_mesh(0.7),
                                              // eng.create_material("sphere_mtl", glengine::StockShader::Phong)};
        eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)};
    ...
    glengine::Renderable polyline_renderable = {polyline_mesh,
        eng.create_material<glengine::MaterialFlat>(SG_PRIMITIVETYPE_LINES, SG_INDEXTYPE_NONE)};
    ...
    glengine::Renderable triangle_renderable = {triangle_mesh,
        eng.create_material<glengine::MaterialVertexColor>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_NONE)};
    ...
    auto sg0 = eng.create_object(
        {box0_renderable.mesh, eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)}, nullptr, 120);
    auto sg1 = eng.create_object(
        {box0_renderable.mesh, eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)}, sg0, 121);
    auto sg2 = eng.create_object(
        {box0_renderable.mesh, eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)}, sg1, 122);
    auto sg3 = eng.create_object(
        {box0_renderable.mesh, eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)}, sg1, 123);
    ...
    glengine::Renderable sg4_renderable = {eng.create_box_mesh({2, 2, 2}),
                                           eng.create_material<glengine::MaterialDiffuse>(SG_PRIMITIVETYPE_TRIANGLES, SG_INDEXTYPE_UINT32)};
