...
bool MaterialDiffuseTextured::init(ResourceManager &rm, sg_primitive_type primitive, sg_index_type idx_type) {
    ...
    sg_pipeline_desc pip_desc = {
        .layout = {.buffers[0].stride = sizeof(Vertex),
                   .attrs =
                       {
                           [ATTR_vs_diffuse_textured_vertex_pos].format = SG_VERTEXFORMAT_FLOAT3,
                           [ATTR_vs_diffuse_textured_vertex_color].format = SG_VERTEXFORMAT_BYTE4N,
                           [ATTR_vs_diffuse_textured_vertex_normal].format = SG_VERTEXFORMAT_FLOAT3,
                           [ATTR_vs_diffuse_textured_vertex_texcoord].format = SG_VERTEXFORMAT_FLOAT2,
                       }},
        ...
        .label = "diffuse textured pipeline"};
