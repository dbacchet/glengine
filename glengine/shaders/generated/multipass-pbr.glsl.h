...
/*
    ...
    vec3 get_normal()
    {
        ...
        vec2 _199 = (texture(normal_texture, v_uv).xy * 2.0) - vec2(1.0);
        float _202 = _199.x;
        float _204 = _199.y;
    ...
    vec3 get_point_shade(vec3 point_to_light, material_info_t material_info, vec3 normal, vec3 view)
    {
        ...
        if (_398)
        {
            ...
            return (((vec3(1.0) - _406) * diffuse(param_9)) + ((_406 * visibility_occlusion(param_5, param_6)) * microfacet_distribution(param_7, param_8))) * _738;
        }
        return vec3(0.0);
    }
    ...
    void main()
    {
        ...
        float _564 = clamp(_554.y * metallic_params[2].x, 0.0, 1.0);
        float _572 = clamp(_554.z * metallic_params[1].w, 0.0, 1.0);
        vec4 param = texture(base_color_texture, v_uv);
        vec3 _586 = (srgb_to_linear(param) * metallic_params[0]).xyz;
        vec3 _600 = mix(vec3(0.039999999105930328369140625), _586, vec3(_572));
        material_info_t param_1 = material_info_t(_564, _600, _564 * _564, (_586 * vec3(0.959999978542327880859375)) * (1.0 - _572), vec3(clamp(max(max(_600.x, _600.y), _600.z) * 50.0, 0.0, 1.0)), _600);
        ...
        color = _664;
        vec3 param_5 = _664;
        frag_color = vec4(tone_map(param_5), 1.0) * 1.0;
        if (texture(base_color_texture, v_uv).w < 0.100000001490116119384765625)
        {
            discard;
        }
...
*/
static const char metallic_fs_source_glsl330[6738] = {
    ...
    0x78,0x74,0x75,0x72,0x65,0x2c,0x20,0x76,0x5f,0x75,0x76,0x29,0x2e,0x78,0x79,0x20,
    ...
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x37,0x33,0x38,0x20,0x3d,0x20,0x5f,0x33,
    0x38,0x38,0x2e,0x6e,0x5f,0x64,0x6f,0x74,0x5f,0x6c,0x3b,0x0a,0x20,0x20,0x20,0x20,
    0x62,0x6f,0x6f,0x6c,0x20,0x5f,0x33,0x39,0x31,0x20,0x3d,0x20,0x5f,0x37,0x33,0x38,
    ...
    0x2a,0x20,0x5f,0x37,0x33,0x38,0x3b,0x0a,0x20,0x20,0x20,0x20,0x7d,0x0a,0x20,0x20,
    ...
    0x70,0x28,0x5f,0x35,0x35,0x34,0x2e,0x79,0x20,0x2a,0x20,0x6d,0x65,0x74,0x61,0x6c,
    ...
    0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x35,0x37,0x32,0x20,0x3d,0x20,0x63,0x6c,0x61,
    0x6d,0x70,0x28,0x5f,0x35,0x35,0x34,0x2e,0x7a,0x20,0x2a,0x20,0x6d,0x65,0x74,0x61,
    ...
    0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x35,0x38,0x36,0x20,0x3d,
    ...
    0x33,0x36,0x39,0x31,0x34,0x30,0x36,0x32,0x35,0x29,0x2c,0x20,0x5f,0x35,0x38,0x36,
    0x2c,0x20,0x76,0x65,0x63,0x33,0x28,0x5f,0x35,0x37,0x32,0x29,0x29,0x3b,0x0a,0x20,
    ...
    0x34,0x2c,0x20,0x5f,0x36,0x30,0x30,0x2c,0x20,0x5f,0x35,0x36,0x34,0x20,0x2a,0x20,
    0x5f,0x35,0x36,0x34,0x2c,0x20,0x28,0x5f,0x35,0x38,0x36,0x20,0x2a,0x20,0x76,0x65,
    ...
    0x2a,0x20,0x28,0x31,0x2e,0x30,0x20,0x2d,0x20,0x5f,0x35,0x37,0x32,0x29,0x2c,0x20,
    0x76,0x65,0x63,0x33,0x28,0x63,0x6c,0x61,0x6d,0x70,0x28,0x6d,0x61,0x78,0x28,0x6d,
    0x61,0x78,0x28,0x5f,0x36,0x30,0x30,0x2e,0x78,0x2c,0x20,0x5f,0x36,0x30,0x30,0x2e,
    0x79,0x29,0x2c,0x20,0x5f,0x36,0x30,0x30,0x2e,0x7a,0x29,0x20,0x2a,0x20,0x35,0x30,
    0x2e,0x30,0x2c,0x20,0x30,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x29,0x29,0x2c,0x20,
    0x5f,0x36,0x30,0x30,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x33,0x20,
    ...
    0x28,0x70,0x61,0x72,0x61,0x6d,0x5f,0x35,0x29,0x2c,0x20,0x31,0x2e,0x30,0x29,0x20,
    0x2a,0x20,0x31,0x2e,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,0x74,
    0x65,0x78,0x74,0x75,0x72,0x65,0x28,0x62,0x61,0x73,0x65,0x5f,0x63,0x6f,0x6c,0x6f,
    0x72,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x2c,0x20,0x76,0x5f,0x75,0x76,0x29,
    ...
    0x3d,0x20,0x66,0x72,0x61,0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x7d,0x0a,
    0x0a,0x00,
};
